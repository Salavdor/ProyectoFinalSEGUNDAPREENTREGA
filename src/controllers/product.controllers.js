...
createProducts = async(req, res, next) => {
  try {
      ...
      if (!title || !category || !price || !stock || !thumbnails) return httpResponse.NotFound(res, "Faltan parámetros para crear el producto."), logger.warn(`🚫 Faltan parámetros para crear el producto.`);
