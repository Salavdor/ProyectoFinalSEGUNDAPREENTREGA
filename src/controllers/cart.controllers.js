...
export default class ProductController extends Controllers {
  ...
  addProduct = async (req, res, next) => {
    try {
      ...
      if (!foundProductInCart) return httpResponse.NotFound(res, `producto: ${product.name} no existe en  ${cart._id} Cart`), logger.warn(`🚫 producto: ${product.name} no existe en  ${cart._id} Cart`);
